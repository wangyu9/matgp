function [H,V,t] = IsoLine_helper(Surf,F,V,Col)

% this is modified by wangyu from IsoLine
% to use it , do something like:
% [h,v,t] = IsoLine_helper({F,V},dBL,40);
