function L = cotmatrix_intrinsic_weighted(l,F,nvert,w)
  ...
  cot12 = ((l1.^2 + l2.^2 -l3.^2)./dblA/4) .* (w(i1)+w(i2)); 
  cot23 = ((l2.^2 + l3.^2 -l1.^2)./dblA/4) .* (w(i2)+w(i3));
  cot31 = ((l1.^2 + l3.^2 -l2.^2)./dblA/4) .* (w(i3)+w(i1));
