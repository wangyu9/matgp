classdef deform < handle
  ...
  properties(GetAccess=public,SetAccess=protected)
    ...
    new_C  
    % added by wangyu initial pose of control vertices, not rest pose of control vertices
    C0
  ...
  methods(Access=public)
    ...
    % See also: deform
      ...
      %added by wangyu:
      if(size(this.C0,1)==size(this.C,1))
        set_new_C(this,this.C0);
  ...
  methods(Access=public)
    ...
    function oncontrolsdrag(src,ev,this)
      ...
      % writeOBJ('temp.obj',this.new_V,this.F);
      % writeDMAT('H_auto_dof.dmat',this.new_C);
    end
